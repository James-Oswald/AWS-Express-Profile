...
function getHolidays(){
  ...
  let res = request("GET", "https://date.nager.at/api/v2/publicholidays/" + year + "/US");
  let holidays = JSON.parse(res.getBody())
  return holidays;
}

app.get('/holidays', function(req, res, next){
  res.render('holidays', {title: 'Holidays', loggedIn: req.session.loggedIn, connection:connection, getHolidays: getHolidays});
});
